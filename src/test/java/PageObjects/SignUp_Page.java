...
public class SignUp_Page {
	...
	public static WebElement foreName_Field(WebDriver driver) throws Exception
	{
		try {
	...
	public static WebElement surName_Field(WebDriver driver) throws Exception
	{
		try {
			element = null;
	...
	public static WebElement gender_Field(WebDriver driver , String str) throws Exception
	{
		try {
			element = null;
	...
	public static WebElement addressLine1_Field(WebDriver driver) throws Exception
	{
		try {
			element =null;
	...
	public static WebElement addressLine2_Field(WebDriver driver) throws Exception
	{
		try {
			element = null;
	...
	public static WebElement city_Field(WebDriver driver) throws Exception
	{
		try {
			element = null;
	...
	public static WebElement postalCode_Field(WebDriver driver) throws Exception
	{
		try {
			element = null;
	...
	public static WebElement telephone_Field(WebDriver driver) throws Exception
	{
		try {
			element = null;
	...
	public static WebElement country_Field(WebDriver driver) throws Exception
	{
		try {
			element = null;
	...
	public static WebElement submit_Field(WebDriver driver) throws Exception
	{
		try {
			element = null;
